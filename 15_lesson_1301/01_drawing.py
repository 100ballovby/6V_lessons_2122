...
x_cor = 350  # изначальная координата каждой фигуры
y_cor = 10  # изначальная координата каждой фигуры
for i in range(10):  # повторить 10 раз
    rect(screen, (180, 15, 180), [x_cor, y_cor, 43, 43], 2)  # рисую квадрат
    circle(screen, (255, 255, 255), [x_cor + 21.5, y_cor + 21.5], 15)  # рисую круг в центре квадрата
    y_cor += 45  # изменяю координаты, чтобы фигуры смещались
    x_cor += 45  # изменяю координаты, чтобы фигуры смещались
